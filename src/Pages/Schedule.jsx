...
const Schedule = () => {
  ...
  if (currentWeek === 1 || currentWeek === 3) {
    piketGroup = [
      ["Kayla", "Fitri", "Julia", "Alvin", "Dira", "Riski"],
      ["Memey", "Aura", "Amelia", "Nazar", "Risky", "Ilpad"],
      ["Tiara", "Deiva", "Resti", "Rafael", "Rehan", "Agis", "Rayhan"],
      ["Sekar", "Anisa", "Yunita", "Uding", "Azwa", "Budi"],
      ["Falah", "Kiki", "Putri", "Nadita", "Nurul"],
    ];
  }
